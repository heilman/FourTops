...
////////////////////////////////    
  ...
  JetCombiner* jetCombiner = new JetCombiner(TrainMVA, Luminosity, datasets, MVAmethod, false);
    ...
    //comment this for training
     MVAComputer* Eventcomputer_ = new MVAComputer("BDT","MasterMVA.root","MasterMVA",MVAvars, "test_El_synclana");
...
eventlist.close();
    ...
    if(trainEventMVA) Eventtrainer_->TrainMVA("Block","",0,0,"",0,0,"test_El_synclana");
