...
// mistag scalefactor => TCHEL: data/MC scalefactor = 1.11 +- 0.12,    TCHEM: data/MC scalefactor = 1.21 +- 0.17
 ...
 // setTDRStyle();
  ...
  string postfix = "_EventSelection_synclana"; // to relabel the names of the output file
 ...
 //   MVAvars.push_back("PTBalTopEventX");
  ...
  //  MVAvars.push_back("Jet4Pt");
   ...
   // MVAComputer* Eventcomputer_ = new MVAComputer("BDT","MasterMVA.root","MasterMVA",MVAvars, "test");
      ...
      //comment these lines for training 
     MVAComputer* Eventcomputer_ = new MVAComputer("BDT","MasterMVA_Mu.root","MasterMVA_Mu",MVAvars, "_synclana");
...
/////////////////////////////////
  ...
  for (unsigned int d = 0; d < datasets.size(); d++) //d < datasets.size()
  {
    ...
    string dataSetName = datasets[d]->Name();	
     ...
     string Ntupname = "QuadTuple_" + dataSetName + ".root";
     string Ntuptitle = "QuadTuple_" + dataSetName;



     TNtuple * tup = new TNtuple(Ntuptitle.c_str(),Ntuptitle.c_str(),"MVA:Njets:ScaleFactor:NormFactor:Luminosity");
...
////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	tup->Fill(BDTscore,njets,scaleFactor,datasets[d]->NormFactor(),Luminosity);
...
eventlist.close();
    ...
    if(trainEventMVA) Eventtrainer_->TrainMVA("Block","",0,0,"",0,0,"_synclana");
