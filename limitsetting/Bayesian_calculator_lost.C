...
void Bayesian_calculator(const char* infile = "results/tttt_combined_my_measurement_model.root",
...
*/
  ...
  */
  ...
  // make a plot
  c1 = new TCanvas("IntervalPlot");
  MCMCIntervalPlot plot(*interval);
  plot.Draw();
  c1->Update();

  c1->SaveAs("plots/tttt.root");
/*
  ...
  c2->SaveAs("plots/Bayesian_OppSignMu_2.root");
*/  
