///////////////////////////////////////////////////////////////////////////////////////////////////////////
// Calculating confidence levels on the cross-section for the T1tttt signal
//
// - This macro is partially based on the RooStats Tutorial 'StandardHypoTestInvDemo.C'
// for the implementation of the rootfile, workspace and modelconfig
//
//
// - The input rootfile for this code is created through HistFac.C, for which the basic code is found
// at: http://ghl.web.cern.ch/ghl/html/HistFactoryDoc.html
//
//
// 
//
...
int nToyToRebuild = 500;                 // number of toys used to rebuild 
...
RooStats::HypoTestInvTool::AnalyzeResult( HypoTestInverterResult * r,
   ...
   if (mPlotHypoTestResult) { 
      ...
      c2->SaveAs("plots/ProfLL.root");
   }
   c1->SaveAs("plots/p-values.root");
}
