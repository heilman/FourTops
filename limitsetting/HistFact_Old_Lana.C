...
std::string infile_nom_el = "NominalShapes_El_preApp.root";
std::string infile_shapes_mu = "SystematicShapes_norm_Mu.root";
std::string infile_nom_mu = "NominalShapes_Mu_preApp.root";
...
void HistFact(bool StatsOn, bool OverallSysOn, bool ShapeSysOn, bool ScaleOn, bool MatchingOn, bool JESOn, bool bTagOn, bool misTagOn, bool ttbbOn, bool leptonSFOn, bool PUOn, bool JEROn)
{
  // using c++ and ROOT
  ...
  //chanMu.SetData("data_20fbtttt", infile_nom_mu);
