...
{
 TFile* f_Mu = new TFile("NominalShapes_Mu.root");
 ...
 TFile* f1_Mu = new TFile("FourTop_EventSelection_wMETCut_Mu_preApp.root");


 TFile* f2_Mu = new TFile("SystematicShapes_Mu_preApp_tttt.root"); 
 TFile* f2_El = new TFile("SystematicShapes_El_preApp_tttt.root"); 


  TH1F * hTT_Mu = (TH1F*)f_Mu->Get("tt");
  ...
  TH1F * hSig_Mu = (TH1F*)f1_Mu->Get("MultiSamplePlot_MVA/MVA_NP_overlay_TTTT");
  ...
  TH1F * h_ttbb_Up_El = (TH1F*)f3->Get("ttbb_Up");
  ...
  TH1F * h_JES_Down_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_JES_Down");
  TH1F * h_JES_Up_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_JES_Up");
  TH1F * h_JER_Down_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_JER_Down");
  TH1F * h_JER_Up_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_JER_Up");
  TH1F * h_bTag_Down_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_bTag_Down");
  TH1F * h_bTag_Up_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_bTag_Up");
  TH1F * h_misTag_Down_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_misTag_Down");
  TH1F * h_misTag_Up_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_misTag_Up");
  TH1F * h_leptonSF_Down_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_LeptonSF_Down");
  TH1F * h_leptonSF_Up_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_LeptonSF_Up");
  TH1F * h_PU_Down_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_PU_Down");
  TH1F * h_PU_Up_tttt_mu = (TH1F*)f2_Mu->Get("MVAtttt_PU_Up");
...
cout<<" here 1 "<<endl;
 ...
 myfile.close();
  ...
  double k_factor = 1.00555;

  cout<<"JES "<<hSig_El->Integral(0,16)<<" "<<h_JES_Down_tttt->Integral(0,16)<<" "<<h_JES_Up_tttt->Integral(0,16)<<"  "<<100*((k_factor*h_JES_Down_tttt->Integral(0,16)- hSig_El->Integral(0,16) )/(hSig_El->Integral(0,16)))<<" %  " << 100*((k_factor*h_JES_Up_tttt->Integral(0,16)- hSig_El->Integral(0,16) )/(hSig_El->Integral(0,16)) )      <<endl;
  cout<<"JER "<<hSig_El->Integral(0,16)<<" "<<h_JER_Down_tttt->Integral(0,16)<<" "<<h_JER_Up_tttt->Integral(0,16)<<"  "<<100*((k_factor*h_JER_Down_tttt->Integral(0,16)- hSig_El->Integral(0,16))/(hSig_El->Integral(0,16)))<<" %  " << 100*((k_factor*h_JER_Up_tttt->Integral(0,16)- hSig_El->Integral(0,16) )/(hSig_El->Integral(0,16)) )      <<endl;
  cout<<"bTag "<<hSig_El->Integral(0,16)<<" "<<h_bTag_Down_tttt->Integral(0,16)<<" "<<h_bTag_Up_tttt->Integral(0,16)<<"  "<<100*((k_factor*h_bTag_Down_tttt->Integral(0,16)- hSig_El->Integral(0,16) )/(hSig_El->Integral(0,16)))<<" %  " << 100*((k_factor*h_bTag_Up_tttt->Integral(0,16)- hSig_El->Integral(0,16) )/(hSig_El->Integral(0,16)) )      <<endl;
  cout<<"misTag "<<hSig_El->Integral(0,16)<<" "<<h_misTag_Down_tttt->Integral(0,16)<<" "<<h_misTag_Up_tttt->Integral(0,16)<<"  "<<100*((k_factor*h_misTag_Down_tttt->Integral(0,16)- hSig_El->Integral(0,16) )/(hSig_El->Integral(0,16)))<<" %  " << 100*((k_factor*h_misTag_Up_tttt->Integral(0,16)- hSig_El->Integral(0,16)))/(hSig_El->Integral(0,16))       <<endl;
  cout<<"leptonSF "<<hSig_El->Integral(0,16)<<" "<<h_leptonSF_Down_tttt->Integral(0,16)<<" "<<h_leptonSF_Up_tttt->Integral(0,16)<<"  "<<100*((k_factor*h_leptonSF_Down_tttt->Integral(0,16)- hSig_El->Integral(0,16))/(hSig_El->Integral(0,16)))<<" %  " << 100*((k_factor*h_leptonSF_Up_tttt->Integral(0,16)- hSig_El->Integral(0,16))/(hSig_El->Integral(0,16))    )   <<endl;
  cout<<"PU "<<hSig_El->Integral(0,16)<<" "<<h_PU_Down_tttt->Integral(0,16)<<" "<<h_PU_Up_tttt->Integral(0,16)<<"  "<<100*((k_factor*h_PU_Down_tttt->Integral(0,16)- hSig_El->Integral(0,16) )/(hSig_El->Integral(0,16)))<<" %  " << 100*((k_factor*h_PU_Up_tttt->Integral(0,16)- hSig_El->Integral(0,16) )/(hSig_El->Integral(0,16)))       <<endl;
  ...
  cout<<"JES "<<hSig_Mu->Integral(0,16)<<" "<<h_JES_Down_tttt_mu->Integral(0,16)<<" "<<h_JES_Up_tttt_mu->Integral(0,16)<<"  "<<100*((k_factor*h_JES_Down_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16) )/(hSig_Mu->Integral(0,16)))<<" %  " << 100*((k_factor*h_JES_Up_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16) )/(hSig_Mu->Integral(0,16)) )      <<endl;
  cout<<"JER "<<hSig_Mu->Integral(0,16)<<" "<<h_JER_Down_tttt_mu->Integral(0,16)<<" "<<h_JER_Up_tttt_mu->Integral(0,16)<<"  "<<100*((k_factor*h_JER_Down_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16))/(hSig_Mu->Integral(0,16)))<<" %  " << 100*((k_factor*h_JER_Up_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16) )/(hSig_Mu->Integral(0,16)) )      <<endl;
  cout<<"bTag "<<hSig_Mu->Integral(0,16)<<" "<<h_bTag_Down_tttt_mu->Integral(0,16)<<" "<<h_bTag_Up_tttt_mu->Integral(0,16)<<"  "<<100*((k_factor*h_bTag_Down_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16) )/(hSig_Mu->Integral(0,16)))<<" %  " << 100*((k_factor*h_bTag_Up_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16) )/(hSig_Mu->Integral(0,16)) )      <<endl;
  cout<<"misTag "<<hSig_Mu->Integral(0,16)<<" "<<h_misTag_Down_tttt_mu->Integral(0,16)<<" "<<h_misTag_Up_tttt_mu->Integral(0,16)<<"  "<<100*((k_factor*h_misTag_Down_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16) )/(hSig_Mu->Integral(0,16)))<<" %  " << 100*((k_factor*h_misTag_Up_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16)))/(hSig_Mu->Integral(0,16))       <<endl;
  cout<<"leptonSF "<<hSig_Mu->Integral(0,16)<<" "<<h_leptonSF_Down_tttt_mu->Integral(0,16)<<" "<<h_leptonSF_Up_tttt_mu->Integral(0,16)<<"  "<<100*((k_factor*h_leptonSF_Down_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16))/(hSig_Mu->Integral(0,16)))<<" %  " << 100*((k_factor*h_leptonSF_Up_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16))/(hSig_Mu->Integral(0,16))    )   <<endl;
  cout<<"PU "<<hSig_Mu->Integral(0,16)<<" "<<h_PU_Down_tttt_mu->Integral(0,16)<<" "<<h_PU_Up_tttt_mu->Integral(0,16)<<"  "<<100*((k_factor*h_PU_Down_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16) )/(hSig_Mu->Integral(0,16)))<<" %  " << 100*((k_factor*h_PU_Up_tttt_mu->Integral(0,16)- hSig_Mu->Integral(0,16) )/(hSig_Mu->Integral(0,16)))       <<endl;
