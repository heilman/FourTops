...
std::string infile_extrashapes_mu = "extra_shapes_mu.root";
std::string infile_extrashapes_el = "extra_shapes_el.root";
...
void HistFact(){
   ...
   signal_mu.AddNormFactor("SigXsecOverSM", 20, poimin, poimax);
   ...
   background1_mu.AddHistoSys("linear","linear_down", infile_extrashapes_mu,"","linear_up", infile_extrashapes_mu,"");
   background1_mu.AddHistoSys("parabolic","parabolic_down", infile_extrashapes_mu,"","parabolic_up", infile_extrashapes_mu,"");
   ...
   //Add electron channel in the exactly same way      
    ...
    signal_el.AddNormFactor("SigXsecOverSM", 20, poimin, poimax);
    ...
    background1_el.AddHistoSys("linear","linear_down", infile_extrashapes_el,"","linear_up", infile_extrashapes_el,"");
    background1_el.AddHistoSys("parabolic","parabolic_down", infile_extrashapes_el,"","parabolic_up", infile_extrashapes_el,"");
