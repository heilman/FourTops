...
print "############################################"
os.system('rm log')
os.system('cp FourTop_EventSelection.cc FourTop_EventSelection.cc.back')
...
print "############################################"
print "########          SENT MAIL        #######"
print "########   STARTING FIRST SYSTEMATIC>>>>>>>#######"
print "############################################"
print "############################################"
print "############################################"
...
for i, line in enumerate(fileinput.input('FourTop_EventSelection.cc', inplace=1)):
       sys.stdout.write(line.replace('int doScaleShift = 0;', 'int doScaleShift = 1;')) 
  
#compile
os.system('g++ -g -L ~/lib -I ../../ -l TopTreeAnaContent53 -l TopTreeAna53 -l MLP -l TreePlayer -l TMVA -l XMLIO -I `root-config --incdir` `root-config --libs` FourTop_EventSelection.cc -o MACRO')
...
#edit alg to switch bool
for i, line in enumerate(fileinput.input('FourTop_EventSelection.cc', inplace=1)):
                sys.stdout.write(line.replace('int doMatchingShift = 1;', 'int doMatchingShift = 2;'))
